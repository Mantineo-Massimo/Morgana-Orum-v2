            ...
            <div className="absolute inset-0 h-full w-full pointer-events-none z-0 overflow-hidden">
                ...
                <div
                    className={cn(
                        ...
                        // Dynamic width logic
                        isScrolled
                            ? brand ? "w-[85%] sm:w-[75%] md:w-[50%] lg:w-[40%] xl:w-[45%]" : "w-[75%] sm:w-[65%] md:w-[45%] lg:w-[40%] xl:w-[45%]"
                            : brand ? "w-[90%] sm:w-[80%] md:w-[60%] lg:w-[42%] xl:w-[48%]" : "w-[80%] sm:w-[70%] md:w-[55%] lg:w-[42%] xl:w-[48%]"
                    )}
                />
            </div>
