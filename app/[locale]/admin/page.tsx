...
export default async function AdminPage() {
    ...
    return (
        <div className="space-y-10 animate-in fade-in duration-500 pb-12">
            ...
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
                ...
                <div className="flex items-center gap-3">
                    <Link
                        ...
                        className="flex items-center gap-2 px-4 py-2.5 bg-[#18182e] text-white rounded-xl text-sm font-bold hover:bg-black transition-all shadow-sm"
                    >
            ...
            <div className="bg-[#18182e] p-8 rounded-3xl text-white relative overflow-hidden group">
