            ...
            <div className="bg-gradient-to-r from-slate-900 to-slate-950 p-8 rounded-3xl text-white relative overflow-hidden group border border-slate-800 shadow-lg">
                <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-6">
                    ...
                    <Link
                        ...
                        className="px-6 py-3 bg-white text-slate-900 rounded-2xl font-bold text-xs hover:bg-slate-100 active:scale-95 transition-all shadow-xl whitespace-nowrap tracking-wider"
                    >
                        VAI ALLE ANALYTICS 📈
                    </Link>
                </div>
