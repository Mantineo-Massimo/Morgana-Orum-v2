...
export default function GruppiPage() {
    ...
    const filteredDepartments = Object.entries(DEPARTMENTS).reduce((acc, [dept, groups]) => {
        const matchingGroups = groups.filter(g => g.name.toLowerCase().includes(search.toLowerCase()));
