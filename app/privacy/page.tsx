            ...
            <div className="container max-w-4xl mx-auto px-6">
                ...
                <div className="bg-white rounded-[2.5rem] border border-zinc-200 p-8 md:p-16 shadow-sm">
                    ...
                    <div className="prose prose-zinc max-w-none text-zinc-600 leading-relaxed font-medium">
                        ...
                        <h2 className="text-2xl font-bold text-foreground mt-12 mb-6">1. Titolare del Trattamento</h2>
                        <p>
                            Le Associazioni Universitarie Morgana & O.R.U.M., con sede in Via Sant&apos;Elia 11, Messina (ME), sono i contitolari del trattamento dei dati raccolti tramite questo portale.
                        </p>

                        <h2 className="text-2xl font-bold text-foreground mt-12 mb-6">2. Dati Raccolti</h2>
                        <p>
                        ...
                        <h2 className="text-2xl font-bold text-foreground mt-12 mb-6">3. Finalità del Trattamento</h2>
                        <p>
                        ...
                        <h2 className="text-2xl font-bold text-foreground mt-12 mb-6">5. Diritti dell&apos;Interessato</h2>
                        <p>
