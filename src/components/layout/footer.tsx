                        ...
                        <div className="flex flex-col gap-4 mb-2">
                            ...
                            <div className="flex items-center gap-3">
                                ...
                                <Link href="/" className="relative h-12 w-12 md:h-14 md:w-14 hover:scale-110 transition-transform cursor-pointer shrink-0">
                                    <Image src="/assets/backgrounds/morgana.webp" alt="Morgana logo" fill className="object-contain" sizes="56px" priority />
                                </Link>
                                {/* Orum */}
                                <Link href="/" className="relative h-12 w-12 md:h-14 md:w-14 hover:scale-110 transition-transform cursor-pointer shrink-0">
                                    <Image src="/assets/backgrounds/orum.webp" alt="Orum logo" fill className="object-contain" sizes="56px" priority />
                                </Link>
                            </div>
                        </div>
