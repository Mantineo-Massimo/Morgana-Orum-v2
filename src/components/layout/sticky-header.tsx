...
export function StickyHeader({ 
            ...
            brand === "matricole" ? "bg-[#f4b716]" :
                brand === "scipog" ? "bg-[#fbc363]" :
                    brand === "dicam" ? "bg-[#f34ab4]" :
                        brand === "piazzadellarte" ? "bg-[linear-gradient(45deg,#7ac9d6_0%,#79d19a_50%,#f0bd6c_100%)]" :
    ...
    const networkInfo: Record<string, { name: string, logo: string, motto: string }> = {
        unimhealth: { name: "Unimhealth", logo: "/assets/backgrounds/unimhealth.webp", motto: "Rappresentanza medico-sanitaria" },
        economia: { name: "Studenti Economia", logo: "/assets/backgrounds/studentieconomia.webp", motto: "Protagonisti del cambiamento" },
        matricole: { name: "Unime Matricole", logo: "/assets/backgrounds/unimematricole.webp", motto: "Il tuo primo passo in Ateneo" },
        scipog: { name: "Studenti Scipog", logo: "/assets/backgrounds/studentiscipog.webp", motto: "La voce tra Scienze Politiche e Giuridiche" },
        dicam: { name: "Inside Dicam", logo: "/assets/backgrounds/insidedicam.webp", motto: "Creatività e cultura al DICAM" },
        piazzadellarte: { name: "Piazza Dell'Arte 2026", logo: "/assets/backgrounds/piazzadellarte.webp", motto: "Il cuore della creatività studentesca" },
    }
