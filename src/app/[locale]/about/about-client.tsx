                                ...
                                <div className="flex flex-col md:flex-row items-center gap-10 md:gap-12">
                                    ...
                                    <div className="shrink-0 flex items-center gap-4">
                                        <div className="size-20 md:size-32 rounded-2xl md:rounded-3xl bg-white p-3 md:p-4 shadow-2xl rotate-[-6deg] hover:rotate-0 transition-transform duration-500">
                                            <Image src="/assets/backgrounds/morgana.webp" width={100} height={100} className="w-full h-full object-contain" alt="Morgana" />
                                        </div>
                                        <div className="size-20 md:size-32 rounded-2xl md:rounded-3xl bg-white p-3 md:p-4 shadow-2xl rotate-[6deg] hover:rotate-0 transition-transform duration-500">
                                            <Image src="/assets/backgrounds/orum.webp" width={100} height={100} className="w-full h-full object-contain" alt="Orum" />
                                        </div>
                                    </div>
                                </div>
                            </div>
