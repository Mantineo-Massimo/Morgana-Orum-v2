...
export default function EventsAdminClient({
    ...
    const handleExport = async (event: any) => {
        ...
        try {
            ...
            const logoMorgana = await loadLogo("/assets/backgrounds/morgana.webp")
            const logoOrum = await loadLogo("/assets/backgrounds/orum.webp")
                    ...
                    <table className="w-full text-left border-collapse min-w-[1000px]">
                        <thead>
                            <tr className="border-b border-zinc-100 bg-zinc-50/50 text-xs font-bold text-zinc-500 uppercase tracking-wider">
                                ...
                                <th className="px-6 py-4 hidden md:table-cell cursor-default transition-colors text-right">
                                    <div className="flex items-center gap-2 justify-end">
                                        Lingue
                                    </div>
                                </th>
